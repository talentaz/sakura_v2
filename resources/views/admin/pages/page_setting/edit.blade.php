                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <input type="text" name="slug" id="input-slug" class="form-control " placeholder="Unique Slug" value="{{ $page->slug }}" required="">
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control tinymce-editor" name="editor_content" required>{{ $page->editor_content }}</textarea>
                                    <textarea name="plain_content" style="display: none;">{{ $page->plain_content }}</textarea>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="on_menu_order" value="{{ $page->on_menu_order }}" min="0" required />
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="on_menu" id="on_menu" {{ $page->on_menu ? 'checked' : '' }}>
...
@section('script')
    ...
    <script>
        ...
        // Form variables
        let update_url = "{{ route('admin.page_setting.update', $page->id) }}";
