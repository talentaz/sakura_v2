<div class="header">
    ...
    <div class="menu">
        <ul>
            ...
            <li class="dropdown">
                <a href="javascript:void(0);" class="dropbtn {{  request()->routeIs('front.agents.tanzania') ? 'active' : '' }}">Branches</a>
                <div class="dropdown-content">
                    <a href="{{route('front.agents.tanzania')}}" class="{{  request()->routeIs('front.agents.tanzania') ? 'active' : '' }}">Tanzania</a>
                </div>
            </li>
            <li class="dropdown">
