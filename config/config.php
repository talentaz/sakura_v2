...
return [     
    'model_catgory' => [
        ...
        [
          'category_name' => 'Benz',
          'children' => [
           'Actros', 'C-Class', 'E-Class', 'S-Class'
          ],
        ],
        [
          'category_name' => 'Volvo',
