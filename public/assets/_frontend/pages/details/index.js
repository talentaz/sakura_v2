        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                arr.forEach(function (data) {
                    ...
                    delete data["image"];
                    data.src =
                        host + "/uploads/vehicle/" + id + "/real/" + data.src;
                });
                $(this).lightGallery({
                    dynamic: true,
                    dynamicEl: arr,
    ...
    $(".add-notify").click(function (e) {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.result) {
                    toastr["success"](
                        "Added. You will be notified when the vehicle becomes available."
                    );
                    $(e.target).after(
    ...
    $(".select-country").on("change", function (e) {
        ...
        $.ajax({
            ...
            .done(function (response) {
                ...
                $(".port-pc").find("option").remove().end().append(html);
            })
    ...
    $(".select-country").on("change", function (e) {
        ...
        $.ajax({
            ...
            .done(function (response) {
                ...
                html += '<option value="0"></option>';
                $(".port-mb").find("option").remove().end().append(html);
            })
            .fail(function (jqXHR, ajaxOptions, thrownError) {
                console.log("Server error occured");
            });
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.success) {
                    toastr["success"](
                        res.message ||
                            "Thank you for your inquiry! We have sent you a quotation via email."
                    );
                    ...
                    setTimeout(function () {
                        if (res.redirect_url) {
                            ...
                            location.href = login_url; // fallback to login_url if available
                        }
                    }, 3000);
                } else {
                    toastr["error"](
